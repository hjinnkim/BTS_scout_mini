...
int main(int argc, char **argv){
    ...
    private_node.param<std::string>("odom_topic_name", converter.odom_topic_name_, std::string("odom"));
    private_node.param<std::string>("odom_groundtruth_topic_name", converter.odom_groundtruth_topic_name_, std::string("odom_groundtruth"));
